...
module.exports = {
  ...
  */
  head: {
    ...
    link: [{ rel: 'icon', type: 'image/x-icon', href: '/favicon.ico' }, { rel: 'stylesheet', href: 'https://fonts.googleapis.cnpmjs.org/css?family=Roboto:300,400,500,700|Material+Icons' }]
  },
  /*
  ...
  */
  ...
  css: ['@/node_modules/vuetify/dist/vuetify.min.css', '@/assets/css/override.scss'],
  build: {
    analyze: true,
    analyze: {
      analyzerMode: 'static'
